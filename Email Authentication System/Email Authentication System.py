'''
Email Authentication System using File Handling project. In this project user is allowed to sign up, log in, and reset his passwords. Email Address and Password strength are validated using Regular expression. To store the Email address and Password permanently we will use a file. 
